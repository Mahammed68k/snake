      ...
      <div className="z-10 bg-black/50 border border-cyan-500/50 rounded-2xl p-8 shadow-[0_0_40px_rgba(6,182,212,0.2)] backdrop-blur-md w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white font-medium transition-all hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(6,182,212,0.3)]"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-[#1877F2]/10 hover:bg-[#1877F2]/20 border border-[#1877F2]/30 rounded-xl text-white font-medium transition-all hover:border-[#1877F2]/60 hover:shadow-[0_0_15px_rgba(24,119,242,0.3)]"
          >
