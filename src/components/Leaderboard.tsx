...
export default function Leaderboard({ provider, onClose }: LeaderboardProps) {
  ...
  return (
    <article className="w-full h-full bg-gradient-to-b from-[#2e2671] to-[#141235] overflow-hidden relative flex flex-col font-sans">
      {/* Confetti Background */}
      ...
      <div className="flex-1 bg-[#17153a] bg-opacity-95 overflow-y-auto custom-scrollbar border-t border-white/5">
        {loading ? (
          ...
          <div className="flex flex-col">
            {scores.length === 0 ? (
               <p className="text-center text-white py-8 text-sm font-bold">No scores yet. Be the first!</p>
            ) : (
